...
{
    public class LinkRepository : EntityBaseRepository<Link>, ILinkRepository
    {
        ...
        public async Task<LinkHomeModel> FindObject(string slug, string language)
        {
            ...
            switch(obj.Type)
            {
                ...
                case CategoryType.Tag:
                    data.Controller = "TagHome";
                    data.Acction = "Details";
                    break;
                case CategoryType.ImageGallery:
                    data.Controller = "ImageGalleryHome";
                    data.Acction = "Details";
                    break;
                case CategoryType.Register:
                    data.Controller = "AccountHome";
                    data.Acction = "Register";
                    break;
                case CategoryType.Signin:
                    data.Controller = "AccountHome";
                    data.Acction = "Signin";
                    break;
                case CategoryType.Feature:
                    data.Controller = "OtherHome";
                    data.Acction = "Feature";
                    break;
                case CategoryType.Price:
                    data.Controller = "OtherHome";
                    data.Acction = "Price";
                    break;
                case CategoryType.Cooperate:
                    data.Controller = "OtherHome";
                    data.Acction = "Cooperate";
                    break;
                case CategoryType.Document:
                    data.Controller = "OtherHome";
                    data.Acction = "Document";
                    break;
