$(function () {
	...
	var templateOption = {
		...
		blocks = {
			...
			reviewsCarousel2: $('.js-reviews-carousel-2'),
	...
	if (blocks.reviewsCarousel2.length) {
		blocks.reviewsCarousel2.slick({
			mobileFirst: false,
			slidesToShow: 1,
			slidesToScroll: 1,
			infinite: true,
		...
		blocks.reviewsCarousel2.slick('slickPause');
		blocks.reviewsCarousel2.waypoint({
			offset: 500,
			handler: function () {
				$(this.element).slick('slickPlay');
				this.destroy();
