...
namespace PT.Shared
{
...

    {
        ...
        public static string GenPageList(string url, int curentPage, int totalRow, int size, string query = null)
        {
            ...
            {
                str.Append($"<li class=\"page-item {(i == curentPage ? "active":"")}\"><a class=\"page-link\" href=\"{url}?page={i}{(query != null ? $"{query}" : "")}\">{i}</a></li>");
            }
            str.Append("</ul>");
            return str.ToString();
        }
