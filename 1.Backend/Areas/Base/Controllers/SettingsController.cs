...
namespace PT.UI.Areas.Setting.Controllers
{
    ...
    public class SettingsController : BaseController
    {
        ...
        [HttpPost, ActionName("ComputeSha256")]
        public string ComputeSha256(string raw)
        {
            ...
            try
            {
                ...
                return  Functions.ComputeSha256Hash(raw);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost, ActionName("ComputeSha384")]
        public  string ComputeSha384(string raw)
        {
            try
            {
                return  Functions.ComputeSha384Hash(raw);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost, ActionName("ComputeSha512")]
        public  string ComputeSha512(string raw)
        {

            try
            {

                return  Functions.ComputeSha512Hash(raw);
            }
            catch (Exception ex)
            {
