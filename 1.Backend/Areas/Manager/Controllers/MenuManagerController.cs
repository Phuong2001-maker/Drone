    ...
    public class MenuManagerController : Base.Controllers.BaseController
    {
        ...
        public async Task<ResponseModel> CreatePost(MenuModel use)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    CommonFunctions.GenModule(_iHostingEnvironment.WebRootPath, await UpdateGroupMenu(data), ModuleType.Menu, data.Id, data.Language);
        ...
        public async Task<ResponseModel> EditPost(MenuModel use, int id)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    CommonFunctions.GenModule(_iHostingEnvironment.WebRootPath, await UpdateGroupMenu(dl), ModuleType.Menu, dl.Id, dl.Language);
        ...
        public async Task<ResponseModel> DeleteItemPost(int id)
        {
            try
            {
                ...
                CommonFunctions.GenModule(_iHostingEnvironment.WebRootPath, await UpdateGroupMenu(dataParent), ModuleType.Menu, kt.MenuId, dataParent?.Language);
        ...
        public async Task<ResponseModel> CreateItemPost(MenuItemModel use)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    CommonFunctions.GenModule(_iHostingEnvironment.WebRootPath, await UpdateGroupMenu(dataParent), ModuleType.Menu, data.MenuId, dataParent?.Language);
        ...
        public async Task<ResponseModel> EditItemPost(MenuItemModel use, int id)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    CommonFunctions.GenModule(_iHostingEnvironment.WebRootPath, await UpdateGroupMenu(dataParent), ModuleType.Menu, dl.MenuId, dataParent?.Language);
        ...
        public async Task<ResponseModel> UpdateOrderPost([FromBody]string data, int id)
        {
            try
            {
                ...
                CommonFunctions.GenModule(_iHostingEnvironment.WebRootPath, await UpdateGroupMenu(dataParent), ModuleType.Menu, id, dataParent?.Language);
